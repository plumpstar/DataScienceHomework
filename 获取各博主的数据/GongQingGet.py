...
while i <= 816:  # 终止页数
    ...
    # file 为文件路径+文件名
    file = 'D:\数据\共青团中央\第四阶段\共青团中央getIndex' + str(i) + '.json'
    ...
    # 修改url
    url = 'https://m.weibo.cn/api/container/getIndex?type=uid&value=3937348351&containerid=1076033937348351&page=' + str(i)
    print(url)
    s = requests.session()
    s.keep_alive = False
